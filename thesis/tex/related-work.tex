...
- used to separate applicative and monadic part of the dsl
- also possible to split dsl into number and strings part

\cite{AsymptoticImproveBind}
- use CPS to improve asymptotics
- essentially used to reassociate left-associated binds
- this however is already done in scalaz, all binds are
